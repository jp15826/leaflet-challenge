...
function createFeatures(earthquakeData)
{
    ...
    {
        layer.bindPopup(
            `<center><h2>Place: ${feature.properties.place}</h2><hr><h3>Magnitude: ${feature.properties.mag}</h3><h4>Depth: ${feature.geometry.coordinates[2]}</h4></center>`
        )
    }
